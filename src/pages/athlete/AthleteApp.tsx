...
function AthleteBrand() { return <div className="inline-flex items-center gap-2.5" aria-label="EngageFit"><span className="grid h-9 w-9 place-items-center rounded-xl bg-orange-500 text-white shadow-lg shadow-orange-500/25"><Zap className="h-5 w-5 fill-current" /></span><span className="text-xl font-black tracking-[-0.04em] text-white">Engage<span className="text-orange-400">Fit</span></span></div>; }
